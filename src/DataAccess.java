...
public class DataAccess {
    ...
    private final String url = "jdbc:mysql://localhost:3306/cr7_Schano" + "?useTimezone=true&serverTimezone=UTC";
    ...
    public void displayClassesOfTeacher(int teacherId){
        ...
        for (Teacher teacher: classTeacher.values()){
            String format = String.format("Teacher \"" + teacher.getFullName() + "\" teaches following courses:");
